...
export default function webprojects() {
  const [data, setData] = useState<webprojectsData | null>(null);
  ...
  useEffect(() => {
    const projectsRef = ref(db, 'webprojects'); // ✅ pull from webprojects
  ...
  if (loading) return <section id="webprojects" className="section py-16 md:py-20"></section>;
